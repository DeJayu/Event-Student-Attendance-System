...
import accountsetting.changepassword;
     ...
     String query1 = "SELECT * FROM LOGINPROCESS INNER JOIN USERINFO ui ON USERINFO_IDNUMBER = ui.IDNUMBER WHERE USERNAME = ?";
         ...
         try(Connection con = new connection().getconnection()){;
            ...
            if(result1.next()){
               ...
               accountsetting.accountsettings setting = new accountsetting.accountsettings(new MainForm(),true);
               ...
               new MyPanel().resizeimagelabel(bais, setting.profilepicture);
